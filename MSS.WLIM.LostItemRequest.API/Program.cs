...
builder.Services.AddScoped<IRepository<LostItemRequests>, LostItemRequestRepository>();
builder.Services.AddScoped<ILostItemRequestService, LostItemRequestService>();
